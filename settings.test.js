...
test('Vestel settings card links to the hosted borne repérage image only for Vestel configs', async () => {
  ...
  assert.equal(vestelLink.href, 'assets/vestel/borne-vestel.png');

...
if (sourcePng.readUInt32BE(16) !== 716 || sourcePng.readUInt32BE(20) !== 910) {
  throw new Error(`Source F107-020 PNG dimensions are invalid: ${sourcePng.readUInt32BE(16)}x${sourcePng.readUInt32BE(20)}`);
}
